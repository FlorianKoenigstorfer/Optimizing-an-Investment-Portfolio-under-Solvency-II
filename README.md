...
## Errata
Mortality shock direction is inconsistent with the liability formula
On revisiting this project I found a conceptual error in how the §5.2 mortality shock interacts with the liability model. Recording it here rather than silently patching the code, since the thesis PDF is unchanged.
